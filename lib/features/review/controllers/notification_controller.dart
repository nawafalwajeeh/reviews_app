  ...
  static NotificationController instance = Get.find();
   ...
   final List<NotificationModel> mockNotifications = [
    NotificationModel(
      ...
      timeAgo: '2m ago',
      description: 'Sarah M. left an amazing review for Sunset Café. Check it out!',
    ...
    NotificationModel(
      ...
      title: 'Review liked!',
      timeAgo: '15m ago',
      description: '3 people found your review of Ocean View Restaurant helpful.',
    ...
    NotificationModel(
      ...
      timeAgo: '1h ago',
      description: 'Mountain Peak Brewery just opened 0.5 miles from you. Be the first to review!',
    ...
    NotificationModel(
      ...
      timeAgo: '3h ago',
      description: 'The owner of Artisan Coffee House replied to your review. Thanks for the feedback!',
    ...
    NotificationModel(
      ...
      timeAgo: '1d ago',
      description: 'Congratulations! You\'ve written 50 reviews and helped the community discover great places.',
    ...
    NotificationModel(
      ...
      timeAgo: '2d ago',
      description: 'Alex reviewed 2 new places this week. Check out their latest discoveries!',
